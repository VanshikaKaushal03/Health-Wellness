...
async function seed() {
    ...
    const priya = practitioners.find(p => p.email === "priya@example.com");
    ...
    // ===== APPOINTMENTS + PAYMENTS + REPORTS for Dr. Priya Sharma =====
    ...
    console.log('✅ Added rich data for Dr. Priya Sharma (multiple patients, reports & payments).');
