...
/**
 * @route GET /api/practitioner/experts
 * @desc Public route - fetch all practitioners (experts)
 */
router.get('/experts', async (req, res) => {
  try {
    // Find all users with role = 'practitioner'
    const practitioners = await User.find({ role: 'practitioner' })
      .select('name specialization experience fees profile.photo bio');
